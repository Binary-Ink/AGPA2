...
//class BTLTStatsDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	BTLTStatsDemo(HINSTANCE hInstance);
//	~BTLTStatsDemo();
//
...
//	void BTLTStatsDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void BTLTStatsDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / specifically handles textured primitives with directional lights
//	//and fog
//	void BTLTStatsDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
//	void BTLTStatsDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
...
//	void BTLTStatsDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void BTLTStatsDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void BTLTStatsDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit mesh with subsets
//	void BTLTStatsDemo::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit normal mapped mesh with subsets
//	void BTLTStatsDemo::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//#pragma region BTLTMethods
//
//	bool BTLTStatsDemo::CheckPointInRect(int pointX, int pointY, int left, int top, int right, int bottom);
//	void BTLTStatsDemo::CheckMouseHoverMenu();
//	void BTLTStatsDemo::CheckMouseClickMenu();
//	
...
//#endif
//
//	BTLTStatsDemo theApp(hInstance);
//
...
//BTLTStatsDemo::BTLTStatsDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool BTLTStatsDemo::Init(bool fullScreen)
//{
...
//void BTLTStatsDemo::UpdateScene(float dt)
//{
...
//}
//
//void BTLTStatsDemo::BuildGeometryBuffers()
//{
...
//}
//
//void BTLTStatsDemo::InitAudio()
//{
//
//}
//
//void BTLTStatsDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void BTLTStatsDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//void BTLTStatsDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void BTLTStatsDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
