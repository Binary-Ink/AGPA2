...
//class BTLTUIDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	BTLTUIDemo(HINSTANCE hInstance);
//	~BTLTUIDemo();
//
...
//	void BTLTUIDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / specifically handles textured primitives with directional lights
//	//and fog
//	void BTLTUIDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
//	void BTLTUIDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
...
//	void BTLTUIDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void BTLTUIDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void BTLTUIDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit mesh with subsets
//	void BTLTUIDemo::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit normal mapped mesh with subsets
//	void BTLTUIDemo::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//#pragma region BTLTMethods
//
//	bool BTLTUIDemo::CheckPointInRect(int pointX, int pointY, int left, int top, int right, int bottom);
//	void BTLTUIDemo::CheckMouseHoverMenu();
//	void BTLTUIDemo::CheckMouseClickMenu();
//
...
//BTLTUIDemo::BTLTUIDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool BTLTUIDemo::Init(bool fullScreen)
//{
...
//void BTLTUIDemo::UpdateScene(float dt)
//{
...
//
//			mCamera->mGoalPosition.x = currentFocus.x -15.0f;
//			mCamera->mGoalPosition.y = currentFocus.y;
//			mCamera->mGoalPosition.z = currentFocus.z - 15.0f;
//		}
//
//		
//
...
//}
//
//void BTLTUIDemo::BuildGeometryBuffers()
//{
...
//}
//
//void BTLTUIDemo::InitAudio()
//{
//
//}
//
//void BTLTUIDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void BTLTUIDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//void BTLTUIDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void BTLTUIDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
